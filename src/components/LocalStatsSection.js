  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative px-4 md:px-8">
        <h2 className="text-3xl md:text-5xl font-bold text-center mb-2 bg-gradient-to-r from-cyan-400 via-violet-500 to-amber-400 text-transparent bg-clip-text">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {localStats.map((stat, index) => (
            <div key={index} className="group relative h-full text-center">
        ...
        <p className="text-center text-lg md:text-2xl font-bold text-gray-400 mt-10 max-w-2xl mx-auto">
