        ...
        <div className="fixed top-4 left-4 bg-black/80 backdrop-blur-sm border border-slate-700 rounded-lg p-2 text-xs text-white z-50">
          ...
          {elementInfo && (
            <div className="mt-2 border-t border-slate-700 pt-2">
              <div className="text-violet-500 font-bold">Element Info</div>
              <div>Tag: {elementInfo.tagName}</div>
              {elementInfo.id !== 'none' && <div>ID: {elementInfo.id}</div>}
              {elementInfo.classes !== 'none' && (
                <div className="truncate max-w-xs">Class: {elementInfo.classes}</div>
              )}
              <div className="grid grid-cols-2 gap-x-2">
                <div>X: {elementInfo.dimensions.x}</div>
                <div>Y: {elementInfo.dimensions.y}</div>
                <div>W: {elementInfo.dimensions.width}</div>
                <div>H: {elementInfo.dimensions.height}</div>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="bg-black/80 backdrop-blur-sm border border-slate-700 rounded-lg p-4 shadow-lg max-w-sm">
        <div className="flex flex-col space-y-2">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-cyan-400 font-bold">Attention Tracker</h3>
